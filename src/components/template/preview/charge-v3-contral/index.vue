...
<script>
import selectPortTip from '@/components/template/preview/select-port-tip'
import selectTemp from '@/components/template/preview/select-temp'
import selectPaytype from '@/components/template/preview/select-paytype'
import warmTip from '@/components/template/preview/warm-tip'
export default {
    props: {
        selectPort: {
            type: Number,
