<template>
    <div class="history-header padding-x-3 padding-y-3 shadow">
        <ul class="d-flex select-time">
            <li class="position-relative margin-x-2" :class="{'active': type === 'today'}" @click="selectTime('today')">今日</li>
            <li class="position-relative margin-x-2" :class="{'active': type === 'week'}" @click="selectTime('week')">本周</li>
            <li class="position-relative margin-x-2" :class="{'active': type === 'month'}" @click="selectTime('month')">本月</li>
