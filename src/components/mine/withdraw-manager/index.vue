<template>
    <div>
        <hd-title class="bg-white">我的银行卡</hd-title>
        <van-cell-group>
            <van-cell title="我的银行卡" is-link to="/withdraw/mybankcard">
                <template #icon>
                    <img class="icon-img margin-right-1" src="../../../assets/images/mine/卡片.png" alt="">
                </template>
            </van-cell>
        </van-cell-group>
        <hd-line />
            ...
            <van-collapse-item name="1">
                <template #title>
                    <div class="d-flex align-items-center">
                        <img class="icon-img margin-right-1" src="../../../assets/images/mine/提现.png" alt="">
                        <span>提现</span>
                    </div>
                </template>
                <van-cell-group>
                    <van-cell title="提现到微信零钱" label="实时到账" is-link to="/withdraw/page/3"></van-cell>
                    <van-cell title="提现到银行卡" label="第二个工作日到账" is-link @click="handleGoWithdraw(1)"></van-cell>
                    <van-cell title="提现到对公账户" label="七个工作日内到账" is-link @click="handleGoWithdraw(2)"></van-cell>
                </van-cell-group>
            </van-collapse-item>
        </van-collapse>
        <van-collapse v-model="activeNames">
            <van-collapse-item name="2">
                <template #title>
                    <div class="d-flex align-items-center">
                        <img class="icon-img margin-right-1" src="../../../assets/images/mine/团型说明.png" alt="">
                        <span>提现说明</span>
                    </div>
                </template>
                <div class="text-666">
