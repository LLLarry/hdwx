        ...
        <div class="">
            ...
            <div class="post-session">
                <div class="padding-x-2 d-flex align-items-center padding-y-2">
                    <div style="width: 10em;" class="text-666 text-size-md">是否支持退费:</div>
                    <van-switch
            ...
            <!-- 退费标准 -->
            <div class="padding-x-2 d-inline-block" v-if="tempData.permit">
                <template-input class="text-666 text-size-md">
                    退费标准：
                    <template #input>
                        <input
                            placeholder="请选择充电方式"
            ...
            <div class="post-session">
                <div class="padding-x-2 d-flex align-items-center padding-y-2">
                    <div style="width: 10em;" class="text-666 text-size-md">是否支持支付宝充电:</div>
                    <van-switch
            ...
            <div class="post-session padding-x-2">
                <div class="margin-y-2 text-666 text-size-md d-flex align-items-cneter justify-content-between">
                    <span>收费说明：</span>
                    <div v-if="type === 'edit'">
                        <van-button type="primary" size="mini" :disabled="isSystemTem" @click="createHintMessage(1)">默认说明</van-button>
                        <van-button type="primary" size="mini" :disabled="isSystemTem" @click="createHintMessage(2)">自动说明</van-button>
                    </div>
                </div>
                <textarea
...
import ChargeStandard from '@/components/template/v2/charge-standard'
